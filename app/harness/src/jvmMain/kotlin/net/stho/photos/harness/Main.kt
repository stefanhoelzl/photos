 ...
 * constructs anything: `:ui:phone` never learns that the SQL driver is JDBC, that the HTTP engine is
 ...
 * agree: `secrets-env ./gradlew :app:harness:run`, a `photos-cli login` done earlier, or typing
    ...
    companion object {
        fun parse(args: Array<String>): Options {
            ...
            val cache = flag("--cache-root")
                ...
                ?: "${System.getProperty("user.dir")}/.cache/harness"

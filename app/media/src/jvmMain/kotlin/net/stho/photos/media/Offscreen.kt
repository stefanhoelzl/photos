...
/**
 * The Linux roots' half of the control server: the one endpoint that differs by root.
 *
 * The server itself is `:app:control`'s, shared with iOS. What only a Linux root can do is render
 ...
 */
public fun offscreen(content: @Composable () -> Unit): (width: Int, height: Int) -> ByteArray =
 ...
 *
 * Public for the suites, whose screenshots are drawn exactly as `/screenshot` draws them. A

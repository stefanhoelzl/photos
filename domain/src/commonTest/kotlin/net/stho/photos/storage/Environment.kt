 ...
 *
 * Kotlin/Native bundles no test resources, so the SigV4 vector suite — 382 files under
 * `testdata/sigv4` — arrives as a path the build hands over. Reading an environment
